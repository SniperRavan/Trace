 ...
 * Draggable bubble with right-click context menu (close/hide).
 */
    ...
    <div style={{ position: 'fixed', inset: 0, pointerEvents: 'none', zIndex: 2147483647 }}>
      ...
      {showMenu && (
        ...
        >
          <MenuItem
            icon="↗"
            label={overlayOpen ? 'Close panel' : 'Open panel'}
      ...
      {overlayOpen && (
        <div style={{
          ...
          <div style={{ fontSize: 11, color: 'rgba(255,255,255,0.3)', marginBottom: 10, letterSpacing: '0.5px', textTransform: 'uppercase' }}>
            trace · compact panel coming next
          </div>
          <div style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)', lineHeight: 1.6 }}>
            Phase 2 — provider bars, token counts, reset timers.
          </div>
        </div>
      )}
    </div>
